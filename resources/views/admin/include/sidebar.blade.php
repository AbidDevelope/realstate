    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
          <a href="{{ url('viewproperty') }}">
              <i class="bi bi-circle"></i><span>show Property</span>
            </a>
          </li>
        </ul>
      </li> 
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('addartist')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('artistevents')}}">
          <i class="bi bi-people"></i>
          <span>Artists Events</span>
        </a>
      </li>
      <!-- End Forms Nav -->
