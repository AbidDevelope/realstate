          ...
          <div class="col-auto">
            <div class="d-flex align-items-center justify-content-between">
              <div class="logos mr35">
                <a class="header-logo logo1" href="index.html"><img src="{{asset('frontend/pictures/header-logo3.svg')}}" alt="Header Logo"></a>
                <a class="header-logo logo2" href="index.html"><img src="{{asset('frontend/pictures/header-logo3.svg')}}" alt="Header Logo"></a>
              </div>
              <!-- Responsive Menu Structure-->
              <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                <li class="visible_list"> <a class="list-item" href="#"><span class="title">Auction</span></a>
                  <!-- Level Two-->
                  {{--  <ul>
                ...
                <li class="megamenu_style"> <a  class="list-item" href="#"><span class="title">For Sale</span></a>
                  {{--  <ul class="row dropdown-megamenu">
                    ...
                    <li class="col mega_menu_list">
                      ...
                      <ul>
                        <li><a href="page-property-header-map-style.html">Services</a></li>
                ...
                <li class="visible_list"> <a class="list-item" href="#"><span class="title">Services</span></a>
                  {{--  <ul>
                ...
                <li class="visible_list"> <a class="list-item" href="#"><span class="title">Why Auction</span></a>
                  {{--  <ul>
