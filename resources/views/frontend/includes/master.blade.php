            ...
            <nav class="posr">
                <div class="container maxw1600 posr menu_bdrt1">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto">
                            <a class="header-logo" href="index.html"><img src="{{asset('frontend/pictures/header-logo3.svg')}}"
                                    alt="Header Logo"></a>
                        </div>
                        <div class="col-auto">
            ...
            <div class="hsidebar-content">
                <div class="hiddenbar_navbar_content">
                    <div class="hiddenbar_navbar_menu">
                        <ul class="navbar-nav">
                            <li class="nav-item"> <a class="nav-link" href="" role="button">Apartments</a>
                            </li>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header pl30 pr30">
                            <h5 class="modal-title" id="exampleModalLabel">More Filter111</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body pb-0">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="widget-wrapper">
                                        <h6 class="list-title">Bedroomsqqq</h6>
                                        <div class="d-flex">
                                            <div class="selection">
        ...
        <div class="body_content">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-6">
                                <div class="inner-banner-style7 mb30-lg">
                                    <h2 class="hero-title mb30 animate-up-1">Discover a place you'll <br
                                            class="d-none d-lg-block"> love to live</h2>
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <form method="get"
                                                                    ...
                                                                    <div class="box-search">
                                                                        ...
                                                                        <div class="search-suggestions rounded-0">
                                                                            <h6 class="fz14 ml20 mt25 mb-0">Recent
                                                                                Searches</h6>
                                                                            <div class="box-suggestions">
                                                                                <ul class="p-0 m-0">
                                                                                    <li>
                                                                                        <div class="info-product">
                                                                                            <div class="item_title"><i
                                                                                                    class="flaticon-maps pe-2"></i>
                                                                                                New York, NY</div>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div
                                                                ...
                                                                <button class="advance-search-btn mr15" type="button"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#exampleModal"><span
                                                                        class="flaticon-settings"></span>
                                                                    Advanced</button>
                                                                <button class="advance-search-icon ud-btn btn-dark"
                                                                    type="button"><span
                                    ...
                                    <div class="swiper mySwiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide" data-swiper-slide-index="00">
                                                <div class="listing-style13">
                                                    <div class="list-thumb">
                                                        <img class="w-100" src="{{asset('frontend/pictures/slider-home7-2.jpg')}}"
                                                            alt="">
                                                    </div>
                                                    <div class="list-content">
                                                        <div class="h4 list-price animate-up-1 mb-0">$986,00</div>
                                                        <h2 class="list-title animate-up-2"><a href="">Studio
                                                                on Grand Avenue</a></h2>
                                                        ...
                                                        <a href=""
                                                            class="ud-btn btn-transparent2 animate-up-2">View Details<i
                                                                class="fal fa-arrow-right-long"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide" data-swiper-slide-index="01">
                                                <div class="listing-style13">
                                                    <div class="list-thumb">
                                                        <img class="w-100" src="{{asset('frontend/pictures/slider-home7-1.jpg')}}"
                                                            alt="">
                                                    </div>
                                                    <div class="list-content">
                                                        <div class="h4 list-price animate-up-1 mb-0">$14,000</div>
                                                        <h2 class="list-title animate-up-1"><a href="">New
                                            ...
                                            <div class="swiper-slide" data-swiper-slide-index="02">
                                                <div class="listing-style13">
                                                    <div class="list-thumb">
                                                        <img class="w-100" src="{{asset('frontend/pictures/slider-home7-3.jpg')}}"
                                                            alt="">
                                                    </div>
                                                    <div class="list-content">
                                                        <div class="h4 list-price animate-up-1 mb-0">$14,000</div>
                                        ...
                                        <div class="posr mt-4">
                                            <div
                                                class="swpr_custom_prgrsba swiper-pagination swiper-pagination-progressbar">
                                                <span class="swiper-pagination-progressbar-fill"></span> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="pt-0 pb90 pb30-md bgc-white">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="explore-apartment-5col-slider navi_pagi_top_right slider-4-grid owl-carousel owl-theme wow fadeInUp"
                                data-wow-delay="300ms">
                                <div class="item">
                                    <a href="page-property-single-v1.html">
                                        <div class="apartment-style2 text-center mb30">
                                            <div class="apartment-img"><img src="{{asset('frontend/pictures/as-6.jpg')}}"
                                                    alt=""></div>
                                ...
                                <div class="item">
                                    <a href="page-property-single-v1.html">
                                        <div class="apartment-style2 text-center mb30">
                                            <div class="apartment-img"><img src="{{asset('frontend/pictures/as-7.jpg')}}"
                                                    alt=""></div>
                                            <div class="apartment-content">
                                                <h6 class="title mb-0">Single family homes for sale</h6>
                                                <p class="text mb-0">22 Properties</p>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="item">
                                    <a href="page-property-single-v1.html">
                                        <div class="apartment-style2 text-center mb30">
                                            <div class="apartment-img"><img src="{{asset('frontend/pictures/as-8.jpg')}}"
                                                    alt=""></div>
                                            <div class="apartment-content">
                                                <h6 class="title mb-0">Office for sale</h6>
                                                <p class="text mb-0">22 Properties</p>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="item">
                                    <a href="page-property-single-v1.html">
                                        <div class="apartment-style2 text-center mb30">
                                            <div class="apartment-img"><img src="{{asset('frontend/pictures/as-9.jpg')}}"
                                                    alt=""></div>
                                            <div class="apartment-content">
                                ...
                                <div class="item">
                                    <a href="page-property-single-v1.html">
                                        <div class="apartment-style2 text-center mb30">
                                            <div class="apartment-img"><img src="images/listings/as-6.jpg"
                                                    alt=""></div>
                                            <div class="apartment-content">
                                                <h6 class="title mb-0">Apartments for sale</h6>
                                                <p class="text mb-0">22 Properties</p>
                                ...
                                <div class="item">
                                    <a href="page-property-single-v1.html">
                                        <div class="apartment-style2 text-center mb30">
                                            <div class="apartment-img"><img src="images/listings/as-7.jpg"
                                                    alt=""></div>
                                            <div class="apartment-content">
                                                <h6 class="title mb-0">Single family homes for sale</h6>
                                                <p class="text mb-0">22 Properties</p>
                                ...
                                <div class="item">
                                    <a href="page-property-single-v1.html">
                                        <div class="apartment-style2 text-center mb30">
                                            <div class="apartment-img"><img src="images/listings/as-8.jpg"
                                                    alt=""></div>
                                            <div class="apartment-content">
                                                <h6 class="title mb-0">Office for sale</h6>
                                                <p class="text mb-0">22 Properties</p>
                                ...
                                <div class="item">
                                    <a href="page-property-single-v1.html">
                                        <div class="apartment-style2 text-center mb30">
                                            <div class="apartment-img"><img src="images/listings/as-9.jpg"
                                                    alt=""></div>
                                            <div class="apartment-content">
                                                <h6 class="title mb-0">Villas for sale</h6>
                                                <p class="text mb-0">22 Properties</p>
                        ...
                        <div class="col-lg-6">
                            <div class="dark-light-navtab style2 text-start text-lg-end mt-0 mt-lg-4 mb-4">
                                <ul class="nav nav-pills justify-content-start justify-content-lg-end"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link rounded-0 mb10-sm active" id="pills-house-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-house" type="button"
                                            role="tab" aria-controls="pills-house" aria-selected="true">For
                                            Rent</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link rounded-0 mb10-sm" id="pills-villa-tab"
                                            data-bs-toggle="pill" data-bs-target="#pills-villa" type="button"
                                            role="tab" aria-controls="pills-villa" aria-selected="false">For
                                            Sale</button>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 wow fadeInUp" data-wow-delay="300ms">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="{{asset('frontend/pictures/g1-1.jpg')}}"
                                                        alt="">
                                                    <div class="list-tag rounded-0 fz12"><span
                                                            class="flaticon-electricity me-2"></span>FEATURED</div>
                                                    <div class="list-tag2 rounded-0 fz12">FOR SALE</div>
                                                    <div class="list-meta">
                                                        <a class="rounded-0" href=""><span
                                                ...
                                                <div class="list-content">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="list-meta2 d-flex align-items-center">
                                                            <a class="mr10" href=""><span
                                                                    class="flaticon-bed mr5"></span>3</a>
                                                            <a class="mr10" href=""><span
                                                                    class="flaticon-shower mr5"></span>4</a>
                                                            <a href=""><span
                                                                    class="flaticon-expand mr5"></span>1200</a>
                                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="{{asset('frontend/pictures/g1-2.jpg')}}"
                                                        alt="">
                                                    <div class="list-meta">
                                                        <a class="rounded-0" href=""><span
                                                                class="flaticon-like"></span></a>
                                                ...
                                                <div class="list-content">
                                                    <h6 class="list-title"><a
                                                            href="page-property-single-v1.html">Luxury villa in Rego
                                                            Park</a></h6>
                                                    <p class="list-text">California City, CA, USA</p>
                                                    <div
                                                        class="d-flex justify-content-between align-items-center mt-3">
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="{{asset('frontend/pictures/g1-3.jpg')}}"
                                                        alt="">
                                                    <div class="list-meta">
                                                        <a class="rounded-0" href=""><span
                                                                class="flaticon-like"></span></a>
                                                ...
                                                <div class="list-content">
                                                    <h6 class="list-title"><a
                                                            href="page-property-single-v1.html">Villa on Hollywood
                                                            Boulevard</a></h6>
                                                    <p class="list-text">California City, CA, USA</p>
                                                    <div
                                                        class="d-flex justify-content-between align-items-center mt-3">
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="{{asset('frontend/pictures/g1-4.jpg')}}"
                                                        alt="">
                                                    <div class="list-tag rounded-0 fz12"><span
                                                            class="flaticon-electricity me-2"></span>FEATURED</div>
                                                    <div class="list-meta">
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="{{asset('frontend/pictures/g1-5.jpg')}}"
                                                        alt="">
                                                    <div class="list-tag rounded-0 fz12"><span
                                                            class="flaticon-electricity me-2"></span>FEATURED</div>
                                                    <div class="list-meta">
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="{{asset('frontend/pictures/g1-6.jpg')}}"
                                                        alt="">
                                                    <div class="list-meta">
                                                        <a class="rounded-0" href=""><span
                                                                class="flaticon-like"></span></a>
                                ...
                                <div class="tab-pane fade" id="pills-villa" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="images/listings/g1-1.jpg"
                                                        alt="">
                                                    <div class="list-tag rounded-0 fz12"><span
                                                            class="flaticon-electricity me-2"></span>FEATURED</div>
                                                    <div class="list-tag2 rounded-0 fz12">FOR SALE</div>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="images/listings/g1-2.jpg"
                                                        alt="">
                                                    <div class="list-meta">
                                                        <a class="rounded-0" href=""><span
                                                                class="flaticon-like"></span></a>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="images/listings/g1-3.jpg"
                                                        alt="">
                                                    <div class="list-meta">
                                                        <a class="rounded-0" href=""><span
                                                                class="flaticon-like"></span></a>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="images/listings/g1-4.jpg"
                                                        alt="">
                                                    <div class="list-tag rounded-0 fz12"><span
                                                            class="flaticon-electricity me-2"></span>FEATURED</div>
                                                    <div class="list-meta">
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="images/listings/g1-5.jpg"
                                                        alt="">
                                                    <div class="list-tag rounded-0 fz12"><span
                                                            class="flaticon-electricity me-2"></span>FEATURED</div>
                                                    <div class="list-meta">
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            <div class="listing-style8">
                                                <div class="list-thumb">
                                                    <img class="w-100" src="images/listings/g1-6.jpg"
                                                        alt="">
                                                    <div class="list-meta">
                                                        <a class="rounded-0" href=""><span
                                                                class="flaticon-like"></span></a>
                            ...
                            <div class="d-grid d-md-block text-center mt30 mt0-md">
                                <a href="page-grid-default-v1.html" class="ud-btn btn-dark bdrs0">Learn More<i
                                        class="fal fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <section class="pb90 pb30-md">
                <div class="container">
                    ...
                    <div class="row wow fadeInUp" data-wow-delay="300ms">
                        <div class="col-lg-6">
                            <div class="feature-style1 bdrs0 mb30">
                                <div class="feature-img"><img class="w-100"
                                        src="{{asset('frontend/pictures/city-listing-2.jpg')}}" alt=""></div>
                                <div class="feature-content">
                                    <div class="top-area">
                                        <h6 class="title mb-1">New York</h6>
                                        <p class="text">22 Properties</p>
                                    </div>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="feature-style1 bdrs0 mb30">
                                <div class="feature-img"><img class="w-100"
                                        src="{{asset('frontend/pictures/city-listing-3.jpg')}}" alt=""></div>
                                <div class="feature-content">
                                    <div class="top-area">
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="feature-style1 bdrs0 mb30">
                                <div class="feature-img"><img class="w-100"
                                        src="{{asset('frontend/pictures/city-listing-4.jpg')}}" alt=""></div>
                                <div class="feature-content">
                                    <div class="top-area">
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="feature-style1 bdrs0 mb30">
                                <div class="feature-img"><img class="w-100"
                                        src="{{asset('frontend/pictures/city-listing-5.jpg')}}" alt=""></div>
                                <div class="feature-content">
                                    <div class="top-area">
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="feature-style1 bdrs0 mb30">
                                <div class="feature-img"><img class="w-100"
                                        src="{{asset('frontend/pictures/city-listing-6.jpg')}}" alt=""></div>
                                <div class="feature-content">
                                    <div class="top-area">
                        ...
                        <div class="col-lg-6">
                            <div class="feature-style1 bdrs0 mb30">
                                <div class="feature-img"><img class="w-100"
                                        src="{{asset('frontend/pictures/city-listing-7.jpg')}}" alt=""></div>
                                <div class="feature-content">
                                    <div class="top-area">
            ...
            <section class="bgc-thm-light pb90 pb30-md">
                <img class="funfact-floating-img1 wow zoomIn d-none d-lg-block" src="images/resource/h7-bg-1.png"
                    alt="">
                <img class="funfact-floating-img2 wow zoomIn d-none d-lg-block" src="images/resource/h7-bg-2.png"
                    alt="">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-xl-5 wow fadeInRight" data-wow-delay="100ms">
                            <div class="cta-style6 mb30-sm">
                                <h2 class="cta-title mb25">More than 20 Years of Real <br class="d-none d-lg-block">
                                    Estate Experience</h2>
                                <p class="cta-text fz15 mb25">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                    sed <br class="d-none d-lg-block"> do eiusmod tempor incididunt.</p>
                                <a href="page-contact.html" class="ud-btn btn-dark bdrs0">Get Started <i
                                        class="fal fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <div class="funfact-style1 text-center">
                                        <ul class="ps-0 mb-0 d-flex justify-content-center">
                                            <li>
                                                <div class="timer title mb15">2,500</div>
                                            </li>
                                            <li><span>+</span></li>
                                        </ul>
                                    ...
                                    <div class="funfact-style1 text-center">
                                        <ul class="ps-0 mb-0 d-flex justify-content-center">
                                            <li>
                                                <div class="timer title mb15">900</div>
                                            </li>
                                            <li><span>+</span></li>
                                        </ul>
                                ...
                                <div class="col-sm-6">
                                    <div class="funfact-style1 text-center">
                                        <ul class="ps-0 mb-0 d-flex justify-content-center">
                                            <li>
                                                <div class="timer title mb15">1,350</div>
                                            </li>
                                            <li><span>+</span></li>
                                        </ul>
            ...
            <section class="bgc-dark pb130">
                <div class="container">
                    ...
                    <div class="row wow fadeInUp" data-wow-delay="300ms">
                        <div class="col-lg-12">
                            <div
                                class="feature-listing-slider dots_nav_light navi_pagi_bottom_center slider-dib-sm slider-4-grid3 owl-carousel owl-theme">
                                <div class="item">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-xl-4 offset-xl-1">
                                            <div class="testimonial-style4-img position-relative">
                                                <img src="{{asset('frontend/pictures/about-4.jpg')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-6">
                                            <div class="testimonial-style4 position-relative">
                                                ...
                                                <h4 class="title mb25">“Amazing design, easy to customize and a design
                                                    quality superlative account on its cloud platform for the optimized
                                                    performance. And we didn’t on our original designs.”</h4>
                                                <h6 class="author fz14">Dianne Russell</h6>
                                                <p class="desig mb-0">Bank of America</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="iconbox-style2 text-center">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <p class="text">Nullam sollicitudin blandit eros eu pretium. Nullam maximus
                                        ultricies auctor.</p>
                                    <a href="page-property-single-v1.html" class="ud-btn btn-white2 bdrs0 mb20">Find
                                        a home<i class="fal fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="iconbox-style2 active text-center">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <p class="text">Nullam sollicitudin blandit eros eu pretium. Nullam maximus
                                        ultricies auctor.</p>
                                    <a href="page-property-single-v1.html"
                                        class="ud-btn btn-white2 bdrs0 mb20">Place an ad<i
                                            class="fal fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="iconbox-style2 text-center">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <p class="text">Nullam sollicitudin blandit eros eu pretium. Nullam maximus
                                        ultricies auctor.</p>
                                    <a href="page-property-single-v1.html" class="ud-btn btn-white2 bdrs0 mb20">Find
                                        a rental<i class="fal fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="inquiry-form mb30-md">
                                <form class="form-style1">
                                    <div class="row">
                                        ...
                                        <div class="d-grid">
                                            <button class="ud-btn btn-dark bdrs0">Submit <i
                                                    class="fal fa-arrow-right-long"></i></button>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="col-lg-6 col-xl-6 offset-xl-1 wow fadeInLeft" data-wow-delay="300ms">
                            <div class="inquiry-form">
                                <div class="inquiry-img"><img class="w-100" src="{{asset('frontend/pictures/about-3.jpg')}}"
                                        alt="image"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-6 wow fadeInLeft">
                            <div class="cta-style3">
                                ...
                                <p class="cta-text mb25 text-white">We only work with the best companies around the
                                    globe to survey</p>
                                <a href="page-contact.html" class="ud-btn btn-white bdrs0">Register Now <i
                                        class="fal fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-5 col-xl-4 offset-xl-2 d-none d-lg-block wow fadeIn"
                            data-wow-delay="300ms">
                            <div class="cta-img">
                                <img src="{{asset('frontend/pictures/cta-member-1.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Our Footer -->
            <section class="footer-style1 at-home4 pt60 pb-0 text-info" >
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="footer-widget light-style mb-4 mb-lg-5">
                                <a class="footer-logo" href="index.html"><img class="mb40"
                                        src="{{asset('frontend/pictures/header-logo3.svg')}}" alt=""></a>
                                <div class="contact-info mb25">
                                    <p class="text mb5">Address</p>
                                    <h6 class="info-phone"><a href="+(0)-123-050-945-02">329 Queensberry Street,
                                            North Melbourne VIC 3051, Australia.</a></h6>
                                </div>
                                <div class="contact-info mb25">
                                ...
                                <div class="mailchimp-widget mb30">
                                    ...
                                    <div class="mailchimp-style1 at-home7 white-version">
                                        ...
                                        <button class="btn" type="submit"><span
                                                class="flaticon-send"></span></button>
                                    </div>
                                </div>
