...
@section('content-area')
    ...
    <form id="signUpForm" action="#!"> <!-- start step indicators -->
        ...
        <div class="step">
            ...
            <div class="mb-3"> <input type="text" placeholder="Linked In" oninput="this.className = ''"
                    name="linkedin"> </div>
        ...
        <div class="step">
            ...
            <div class="mb-3"> <input type="text" placeholder="Full name" oninput="this.className = ''"
                    name="fullname"> </div>
