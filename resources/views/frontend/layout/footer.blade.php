<section class="footer-style1 at-home4 pt60 pb-0" style="background-color: navy">
    <div class="container" style="color:white">
      <div class="row">
        <div class="col-sm-6 col-lg-3">
          <div class="footer-widget light-style mb-4 mb-lg-5">
            <a class="footer-logo" href="index.html"><img class="mb40" src="{{asset('frontend/pictures/elite.png')}}" alt="" style="height: 100px"></a>
            <div class="contact-info mb25 txt" style="color: white !important">
              <p class="text mb5 txt">Address</p>
              <h6 class="info-phone"><a href="+(0)-123-050-945-02">329 Queensberry Street, North Melbourne VIC 3051, Australia.</a></h6>
            </div>
            <div class="contact-info mb25 txt">
              <p class="text mb5 txt">Total Free Customer Care</p>
              <h6 class="info-phone"><a href="+(0)-123-050-945-02">+(0) 123 050 945 02</a></h6>
            </div>
            <div class="contact-info">
              <p class="text mb5 txt">Nee Live Support?</p>
              <h6 class="info-mail"><a href="mailto:support@nexthome.com">support@nexthome.com</a></h6>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          <div class="footer-widget mb-4 mb-lg-5 ps-0 ps-lg-5">
            <div class="link-style1 light-style mb30">
              <h6 class="mb25 txt">Popular Search</h6>
              <div class="link-list">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="footer-widget mb-4 mb-lg-5 ps-0 ps-lg-5">
            <div class="link-style1 light-style mb-3">
              <h6 class="mb25 txt">Quick Links</h6>
              <ul class="ps-0">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="footer-widget mb-4 mb-lg-5">
            <div class="mailchimp-widget mb30">
              <h6 class="title mb30 txt">Keep Yourself Up to Date</h6>
            ...
            <div class="app-widget at-home7" >
              <h5 class="title mb10 txt">Apps</h5>
              <div class="row">
                <div class="col-auto" >
                  <a href="">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="text-center text-lg-start">
            <p class="copyright-text ff-heading mb-0 txt">© Next Home - All rights reserved</p>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="social-widget text-center text-sm-end">
            <div class="social-style1 light-style">
              <a class="me-2 fw600 fz15 txt" href="">Follow us</a>
